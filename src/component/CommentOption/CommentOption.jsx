...
export default function CommentOption({ CommentId , refetch }) {
    ...
    function handleUpdate( value ){
        ...
        let {data} = axios.put(`https://linked-posts.routemisr.com/comments/${CommentId}`, value, {
            headers: {
                token: localStorage.getItem("token"),
            },
        })
  ...
  return (
    <div>
        <button id="dropdownMenuIconHorizontalButton" data-dropdown-toggle={"dropdown"+ CommentId}  className="inline-flex items-center p-2 text-sm font-medium text-center text-gray-900   rounded-lg hover:cursor-pointer focus:ring-1 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-600" type="button"> 
        ...
        <div id={"dropdown"+ CommentId} className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
