...
export default function Pagination({pagenum , setfun}) {
  ...
  return (
    <nav aria-label="Page navigation example">
        <ul className="flex items-center -space-x-px h-10 text-base fixed bottom-2.5 start-1/2 transform -translate-x-1/2">
            <li>
            ...
            {Array.from({ length: 5 }).map((el , i)=>{
                return <li>
                  <a onClick={(e)=>{setfun(e.target.innerHTML)}} className="flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">{i+1}</a>
                    </li>
            }) }
